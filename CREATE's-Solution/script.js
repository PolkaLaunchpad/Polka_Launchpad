...
async function main() {
  ...
  const REGISTRY_ADDRESS = "0xde56daf91fdfdf1d5e74150a39be262309b7141b";
  ...
  // ─── 2) Compute fees ───────────────────────────────────────────────────────
  const existentialDeposit = 900_000_000_000_000_000n; // 0.1 WND in Planck, 0.1 WND = 100000000000000000 = 100_000_000_000_000_000
  const gasLimit           = 9_000_000_000_000_000;        // hard-coded for testing!

  // fetch gasPrice from getFeeData()
  const feeData = await provider.getFeeData();
  let gasPrice = feeData.gasPrice;
  // fallback if gasPrice is null (e.g. strict EIP-1559 networks)
  if (gasPrice == null) {
    // you can choose between maxFeePerGas or maxPriorityFeePerGas + baseFee
